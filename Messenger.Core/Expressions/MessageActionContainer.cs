...
{
    internal class MessageActionContainer
    {
        ...
        public MessageActionContainer(string type, string method, Type[] parameterTypes, string []arguments)
        {
            Type = type;
            Method = method;
        ...
        public static MessageActionContainer Serialize(MessageAction messageAction)
        {
            return new MessageActionContainer(
